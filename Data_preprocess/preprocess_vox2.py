...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--in_audio_dir",
        type=str,
        default="/home/Dataset/AVSeparation/vox2/audio_10w/wav16k/min",
        help="Directory path of audio including tr, cv and tt",
    )
    parser.add_argument(
        "--in_mouth_dir",
        type=str,
        default="/home/Dataset/AVSeparation/vox2/mouths",
        help="Directory path of video including tr, cv and tt",
    )
    parser.add_argument("--out_dir", type=str, default="/home/code/VAM-Net/data-preprocess/vox2_10w", help="Directory path to put output files")
